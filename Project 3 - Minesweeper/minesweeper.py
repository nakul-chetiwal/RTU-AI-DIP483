...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        # Create set to store undecided cells for Knowledge Base:
        ...
        while newKnowledge:
            ...
            for firstRow in self.knowledge:
                for secondColumn in self.knowledge:

                    # Ignore when sentences are identical
                    if firstRow.cells == secondColumn.cells:
                        continue

                    if firstRow.cells == set() and firstRow.count > 0:
                        raise ValueError

                    # Create a new sentence if 1 is subset of 2, and not in KB:
                    if firstRow.cells.issubset(secondColumn.cells):
                        new_sentence_cells = secondColumn.cells - firstRow.cells
                        new_sentence_count = secondColumn.count - firstRow.count
    ...
    def make_safe_move(self):
        ...
        if remaining_moves:
            return random.choice(list(remaining_moves))
